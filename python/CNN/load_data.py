# -*- coding: utf-8 -*-
"""
Created on Thu Jul 20 09:40:57 2017
...
train_folders = ['./pydatabase/train_pos', './pydatabase/train_neg']
test_folders = ['./pydatabase/test_pos', './pydatabase/test_neg']
data_root = '.'

def load(folder, min_num_images):
...
def maybe_pickle(data_folders, min_num_images_per_class, force=False):
  ...
  for folder in data_folders:
    ...
    if os.path.exists(set_filename) and not force:
      ...
      dataset = load(folder, min_num_images_per_class)
      try:
...
train_datasets = maybe_pickle(train_folders, 10000)
...
pickle_file = os.path.join(data_root, 'cracks.pickle')
